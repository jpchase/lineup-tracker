 ...
 */
const CONTEXT_EVENT_NAME = 'context-request';
export class ContextEvent<T extends UnknownContext> extends Event {
  static eventName = CONTEXT_EVENT_NAME;
  ...
  public constructor(
    ...
    super(ContextEvent.eventName, { bubbles: true, composed: true });
  }
}
...
declare global {
  interface HTMLElementEventMap {
     ...
     */
    [CONTEXT_EVENT_NAME]: ContextEvent<UnknownContext>;
  }
}
